...
function createIconDelete() {
    const a = document.createElement('a');  //// створюємо елемент "а" в НТМІ файлі
...
function createLi(item, index) {
    ...
    const iconDelete = createIconDelete();  //// створив змінну яка запускає функція створення іконки видаллення
