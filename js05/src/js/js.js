...
const time = {
    ...
    sumMinut: function (addMinut) {
        this.minut += addMinut;
        return this.minut
    },
    sumHour: function (addHour) {
        this.hour += addHour;
        return this.hour
    },
    showTime: function (second, minut, hour) {
        alert(`Привіт Друже! На данний час "${this.sumHour(hour)}" годин "${this.sumMinut(minut)}" хвилин та "${this.sumSecond(second)}" секунд.`);
    },
    
}

time.showTime(30,80,50)
